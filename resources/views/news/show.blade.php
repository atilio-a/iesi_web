...
@section('og_image', $news->featured_image ?? asset('images/og-default.svg'))
@section('content')
    <section class="iesi-section">
        <div class="container" style="max-width: 860px;">
            ...
            <img src="{{ $news->featured_image ?? 'https://images.unsplash.com/photo-1456406644174-8ddd4cd52a06?auto=format&fit=crop&w=900&q=80' }}" alt="{{ $news->title }}" class="w-100 mt-4 rounded-4" style="height: 360px; object-fit: cover;" loading="lazy" />
